      ...
      <ul className='flex rounded px-1 py-1'>
        <li className='flex items-center'>
          <button
            ...
            className={`flex gap-2 text-sm font-medium text-neutral-600 disabled:cursor-not-allowed disabled:text-neutral-400 ${
          ...
          item === ELLIPSIS ? (
            ...
            <li key={item}>
              <button
                ...
                className={`${pageButtonBase} ${item === activePage ? activeStyles : inactiveStyles}`}
              >
                {item}
              </button>
            </li>
